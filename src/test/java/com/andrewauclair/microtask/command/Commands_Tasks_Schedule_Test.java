...
public class Commands_Tasks_Schedule_Test extends CommandsBaseTestCase {
	...
	void display_scheduled_tasks_including_finished_tasks() {
		...
		assertOutput(
				"Tasks on Schedule",
				"",
				u + "Project" + r + "  " + u + "Type" + r + "  " + u + "ID" + r + "  " + u + r + "      " + u + "Description" + r,
				ANSI_BG_GRAY + "proj-1         25  (22)  Test       " + ANSI_RESET,
				"proj-1         21  (19)  Test       ",
				ANSI_BG_GRAY + "proj-2         18  (16)  Test       " + ANSI_RESET,
				"proj-1         17  (15)  Test       ",
				ANSI_BG_GRAY + "               16  (14)  Test       " + ANSI_RESET,
				"proj-2         14  (12)  Test       ",
				ANSI_BG_GRAY + "proj-1         13  (11)  Test       " + ANSI_RESET,
				"               12  (10)  Test       ",
				ANSI_BG_GRAY + "proj-3         11   (9)  Test       " + ANSI_RESET,
				"proj-2         10   (8)  Test       ",
				ANSI_BG_GRAY + "proj-1          9   (7)  Test       " + ANSI_RESET,
				"                8   (6)  Test       ",
				ANSI_BG_GRAY + "proj-3     F    7        Test       " + ANSI_RESET,
				"proj-2          6   (5)  Test       ",
				ANSI_BG_GRAY + "proj-1          5   (4)  Test       " + ANSI_RESET,
				"           F    4        Test       ",
				"",
