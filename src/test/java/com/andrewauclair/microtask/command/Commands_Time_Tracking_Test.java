...
class Commands_Time_Tracking_Test extends CommandsBaseTestCase {
	@Test
	void tracking_for_current_week() {
//		tasks.setGroupTimeCategory();
	...
	@Test
	void tracking_for_previous_week_week() {
//		tasks.setGroupTimeCategory();
		tasks.addList(newList("/one"), "overhead-general", true);
		...
		int monday_7am = 1641211200;
		int tuesday_7am = 1641297600;
		int wednesday_7am = 1641384000;
		int thursday_7am = 1641470400;
		int friday_7am = 1641556800;
		...
		commands.execute(printStream, "times tracking --month 1 --day 4");

		assertOutput(
				"Time Tracking for Week of 1/2/2022",
				"",
				"                            Su      Mo      Tu      We      Th      Fr      Sa      Total",
				"link22-implementation            2.75h           4.00h   5.50h   6.00h             18.25h",
				"link22-design                    1.25h   8.00h                   2.00h             11.25h",
