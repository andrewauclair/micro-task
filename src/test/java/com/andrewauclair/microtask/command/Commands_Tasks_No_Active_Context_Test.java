...
class Commands_Tasks_No_Active_Context_Test extends CommandsBaseTestCase {
	...
	void execute_list_command() {
		...
		assertOutput(
				...
				ANSI_BG_GREEN + "*      3  (2)  Task 3     " + ANSI_RESET,
				"       1  (1)  Task 1     ",
				"",
				"Active Task",
				ANSI_BG_GREEN + "*      3  (2)  Task 3     " + ANSI_RESET,
	...
	void display_tasks_in_a_different_group() {
		...
		assertOutput(
				...
				ANSI_BG_GRAY + "two          5  (5)  Task 5     " + ANSI_RESET,
				"two          4  (4)  Task 4     ",
				ANSI_BG_GREEN + "one   *      3  (3)  Task 3     " + ANSI_RESET,
				"one          2  (2)  Task 2     ",
				ANSI_BG_GRAY + "one          1  (1)  Task 1     " + ANSI_RESET,
				"",
	...
	void list_command_caps_at_20_tasks_and_displays_a_count_of_how_many_are_left() {
		...
		assertOutput(
				...
				"",
				u + "Type" + r + "  " + u + "ID" + r + "  " + u + r + "      " + u + "Description" + r,
				ANSI_BG_GRAY + "      21  (21)  Test 21    " + ANSI_RESET,
				"      20  (20)  Test 20    ",
				ANSI_BG_GRAY + "      19  (19)  Test 19    " + ANSI_RESET,
				"      18  (18)  Test 18    ",
				ANSI_BG_GRAY + "      17  (17)  Test 17    " + ANSI_RESET,
				"      16  (16)  Test 16    ",
				ANSI_BG_GRAY + "      15  (15)  Test 15    " + ANSI_RESET,
				"      14  (14)  Test 14    ",
				ANSI_BG_GRAY + "      13  (13)  Test 13    " + ANSI_RESET,
				"      12  (12)  Test 12    ",
				ANSI_BG_GRAY + "      11  (11)  Test 11    " + ANSI_RESET,
				"      10  (10)  Test 10    ",
				ANSI_BG_GRAY + "       9   (9)  Test 9     " + ANSI_RESET,
				"       8   (8)  Test 8     ",
				ANSI_BG_GRAY + "       7   (7)  Test 7     " + ANSI_RESET,
				"       6   (6)  Test 6     ",
				ANSI_BG_GRAY + "       5   (5)  Test 5     " + ANSI_RESET,
				"       4   (4)  Test 4     ",
				ANSI_BG_GRAY + "       3   (3)  Test 3     " + ANSI_RESET,
				"       2   (2)  Test 2     ",
				ANSI_BG_GRAY + "       1   (1)  Test 1     " + ANSI_RESET,
				"",
				"(18 more tasks.)",
				"",
	...
	void list_command_shows_all_tasks_when_all_parameter_is_passed() {
		...
		assertOutput(
				...
				"",
				u + "Type" + r + "  " + u + "ID" + r + "  " + u + r + "      " + u + "Description" + r,
				ANSI_BG_GRAY + "      22  (22)  Test 22    " + ANSI_RESET,
				"      21  (21)  Test 21    ",
				ANSI_BG_GRAY + "      20  (20)  Test 20    " + ANSI_RESET,
				"      19  (19)  Test 19    ",
				ANSI_BG_GRAY + "      18  (18)  Test 18    " + ANSI_RESET,
				"      17  (17)  Test 17    ",
				ANSI_BG_GRAY + "      16  (16)  Test 16    " + ANSI_RESET,
				"      15  (15)  Test 15    ",
				ANSI_BG_GRAY + "      14  (14)  Test 14    " + ANSI_RESET,
				"      13  (13)  Test 13    ",
				ANSI_BG_GRAY + "      12  (12)  Test 12    " + ANSI_RESET,
				"      11  (11)  Test 11    ",
				ANSI_BG_GRAY + "      10  (10)  Test 10    " + ANSI_RESET,
				"       9   (9)  Test 9     ",
				ANSI_BG_GRAY + "       8   (8)  Test 8     " + ANSI_RESET,
				"       7   (7)  Test 7     ",
				ANSI_BG_GRAY + "       6   (6)  Test 6     " + ANSI_RESET,
				"       5   (5)  Test 5     ",
				ANSI_BG_GRAY + "       4   (4)  Test 4     " + ANSI_RESET,
				"       3   (3)  Test 3     ",
				ANSI_BG_GREEN + "*      2   (2)  Test 2     " + ANSI_RESET,
				"       1   (1)  Test 1     ",
				"",
				"Active Task",
				ANSI_BG_GREEN + "*      2   (2)  Test 2     " + ANSI_RESET,
...
//		outputStream.reset();
		...
		assertOutput(
				...
				"",
				u + "List" + r + "     " + u + "Type" + r + "  " + u + "ID" + r + "  " + u + r + "     " + u + "Description" + r,
				ANSI_BG_GRAY + "two             9  (8)  Task 9     " + ANSI_RESET,
				"two             8  (7)  Task 8     ",
				ANSI_BG_GRAY + "two             7  (6)  Task 7     " + ANSI_RESET,
				"one             6  (5)  Task 6     ",
				ANSI_BG_GRAY + "one             5  (4)  Task 5     " + ANSI_RESET,
				"one             4  (3)  Task 4     ",
				ANSI_BG_GREEN + "default  *      3  (2)  Task 3     " + ANSI_RESET,
				"default         1  (1)  Task 1     ",
				"",
				"Active Task",
				ANSI_BG_GREEN + "default  *      3  (2)  Task 3     " + ANSI_RESET,
	...
	void print_tasks_in_group_recursively() {
		...
		assertOutput(
				...
				"",
				u + "List" + r + "           " + u + "Type" + r + "  " + u + "ID" + r + "  " + u + r + "     " + u + "Description" + r,
				ANSI_BG_GRAY + "two/five/nine         9  (9)  Test       " + ANSI_RESET,
				"two/five/nine   R     8  (8)  Test       ",
				ANSI_BG_GRAY + "two/five/nine         7  (7)  Test       " + ANSI_RESET,
				"four                  6  (6)  Test       ",
				ANSI_BG_GRAY + "four            R     5  (5)  Test       " + ANSI_RESET,
				"four                  4  (4)  Test       ",
				ANSI_BG_GRAY + "two/three             3  (3)  Test       " + ANSI_RESET,
				"two/three       R     2  (2)  Test       ",
				ANSI_BG_GRAY + "two/three             1  (1)  Test       " + ANSI_RESET,
				"",
	...
	void long_task_names_are_cutoff() {
		...
		assertOutput(
				...
				"",
				u + "Type" + r + "  " + u + "ID" + r + "  " + u + r + "     " + u + "Description" + r,
				ANSI_BG_GRAY + "       5  (4)  Normal task                                                     " + ANSI_RESET,
				"       4  (3)  Very long titles will be cut off at the side of the screen so...",
				ANSI_BG_GREEN + "*      3  (2)  Very long titles will be cut off at the side of the screen so..." + ANSI_RESET,
				" R     1  (1)  Very long titles will be cut off at the side of the screen so...",
				"",
				"Active Task",
				ANSI_BG_GREEN + "*      3  (2)  Very long titles will be cut off at the side of the screen so..." + ANSI_RESET,
				"",
	...
	void long_task_names_wrap_when_using_verbose() {
		...
		assertOutput(
				...
				u + "Type" + r + "  " + u + "ID" + r + "  " + u + r + "     " + u + "Description" + r,
				ANSI_BG_GRAY + "       5  (4)  Normal task                                                     " + ANSI_RESET,
				"       4  (3)  Very long titles will be wrapped at the side of the screen      ",
				"               instead of being cut off at the edge                            ",
				ANSI_BG_GREEN + "*      3  (2)  Very long titles will be wrapped at the side of the screen      ",
				"               instead of being cut off at the edge                            " + ANSI_RESET,
				" R     1  (1)  Very long titles will be wrapped at the side of the screen      ",
				"               instead of being cut off at the edge                            ",
				"",
				"Active Task",
				ANSI_BG_GREEN + "*      3  (2)  Very long titles will be wrapped at the side of the screen      ",
	...
	void due_tasks_are_displayed_when_having_no_active_context() {
		...
		assertOutput(
				...
				"",
				u + "Type" + r + "  " + u + "ID" + r + "  " + u + r + "     " + u + "Description" + r + "   ",
				ANSI_BG_GREEN + "*      1  (1)  Test          " + ANSI_RESET,
				"",
				"Due Tasks" + ANSI_RESET,
				ANSI_BG_RED + "       3  (3)  Test Due Today" + ANSI_RESET,
				"",
				"Active Task",
				ANSI_BG_GREEN + "*      1  (1)  Test          " + ANSI_RESET,
				"",
	...
	void due_tasks_are_displayed_twice_if_on_current_list() {
		...
		assertOutput(
				...
				"",
				u + "Type" + r + "  " + u + "ID" + r + "  " + u + r + "     " + u + "Description" + r + "      ",
				ANSI_BG_GRAY + "       3  (3)  Test Due Today   " + ANSI_RESET,
				               "       2  (2)  Test Due Tomorrow",
				ANSI_BG_GREEN + "*      1  (1)  Test             " + ANSI_RESET,
				"",
				"Due Tasks" + ANSI_RESET,
				ANSI_BG_RED + "       3  (3)  Test Due Today   " + ANSI_RESET,
