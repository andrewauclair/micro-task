...
public class SetListCommand implements Runnable {
	...
	@CommandLine.Parameters(completionCandidates = ListCompleter.class, description = "The list to set.")
	...
	private static class Args {
		...
		@CommandLine.Option(names = {"--in-progress"}, description = "Set the list state to in progress.")
		private boolean in_progress;
	}

	static final class ProjectFeature {
		@CommandLine.Option(names = {"-p", "--project"}, description = "The project to set.")
		String project;

		@CommandLine.Option(names = {"-f", "--feature"}, description = "The feature to set.")
		String feature;
	}
